    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axios.post(
          "http://localhost:5000/decode_vid",
          formData,
          {
            headers: {
                  ...
                  <div className="card-body form-card p-5">
                    <form onSubmit={decoding.handleSubmit}>
                      ...
                      <div className="mb-3">
                        ...
                        {decoding.touched.frameNumber &&
                        decoding.errors.frameNumber ? (
                          <div className="alert alert-danger mt-2 p-2 rounded-0 fw-bold text-danger">
                            {decoding.errors.frameNumber}
                          </div>
                        ) : null}
                        <input
                          ...
                          value={decoding.values.frameNumber}
                ...
                <div className="card border-0">
                  <div className="card-body bg-info-subtle">
                    ...
                    <p className="mb-4 para">
                      Follow these steps to decode your message from a video
                      file:
                    </p>
                    <ul>
                      <li className="para text-start">
                        Select a video file from which you wish to decode your
                        secret message.
                      </li>
                      <li className="para text-start">
                        Input the frame number where your message is embedded.
                      </li>
                      <li className="para text-start">
