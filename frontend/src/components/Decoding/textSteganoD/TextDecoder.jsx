                ...
                <form className='form-group' onSubmit={decoding.handleSubmit}>
                  <div className="mb-3">
                    ...
                    {decoding.touched.file && decoding.errors.file && (
                      <div className="alert alert-danger p-2 rounded-0 mt-2 text-danger fw-bold">{decoding.errors.file}</div>
                    )}
                    <div className="d-flex align-items-center">
                      ...
                      <button className="btn btn-light  ml-2" type="button" onClick={() => document.getElementById('customFileInput').click()} style={{marginLeft:'20px'}}>
  ...
  <div className="container">
    <div className="card border-0">
      <div className="card-body bg-info-subtle">
        ...
        <p className='mb-4 para'>Follow these steps to decode your message from a text file:</p>
        <ul>
          <li className='para text-start'>Select a text file from which you wish to extract the secret message.</li>
